...
public class DocentesNoEncuestadosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docentes_no_encuestados);
    ...
    private void docentesListViewApi() {
        ...
        String url = "http://192.168.0.6/ProyectoFinal/api/docentes/docentesSinResponder";
